...
def get_ingestion_component(
    ...
    elif ingest_mode == "hierarchical":
        from private_gpt.components.ingest.ParentDocumentIngestComponent import (
            ParentDocumentIngestComponent,
        )

        return ParentDocumentIngestComponent(
            storage_context=storage_context,
            embed_model=embed_model,
            transformations=transformations,
        )
