...
class IngestionHelper:
    ...
    def _exclude_metadata(documents: list[Document]) -> None:
        ...
        for document in documents:
            ...
            document.excluded_embed_metadata_keys = ["doc_id", "file_path", "file_name", "filename", "ingestion_time"]
            # We don't want the LLM to receive these metadata in the context
            document.excluded_llm_metadata_keys = ["doc_id", "file_path", "file_name", "filename", "ingestion_time"]