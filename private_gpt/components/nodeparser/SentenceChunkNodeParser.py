...
class SentenceChunkWindowNodeParser(NodeParser):
    """Sentence chunk window node parser.

    Splits a document into chunks of multiple sentences, with each chunk
    containing a specified number of sentences. Each node contains a window
    from the surrounding chunks in the metadata.
    ...
    sentence_splitter: Callable[[str], List[str]] = Field(
        ...
        description="The text splitter to use when splitting documents into sentences.",
        exclude=True,
    )
    ...
    window_metadata_key: str = Field(
        ...
        description="The metadata key to store the chunk window under.",
    )
    ...
    def class_name(cls) -> str:
        return "SentenceChunkWindowNodeParser"
