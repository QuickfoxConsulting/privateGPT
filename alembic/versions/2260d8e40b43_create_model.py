...
Revision ID: 2260d8e40b43
Revises: 
Create Date: 2025-02-11 10:25:31.845487
...
def upgrade() -> None:
    ...
    sa.Column('version_type', sa.Enum('NEW', 'AMENDMENT', name='versiontype'), nullable=False),
    sa.Column('previous_document_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['doc_type_id'], ['document_type.id'], ),
    sa.ForeignKeyConstraint(['previous_document_id'], ['document.id'], ),
