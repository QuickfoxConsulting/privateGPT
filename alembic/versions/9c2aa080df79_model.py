...
Revision ID: 9c2aa080df79
Revises: 
Create Date: 2025-02-14 12:07:04.552758
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['uploaded_by'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('document_id', 'version_number', name='uix_document_document_version')
    )
